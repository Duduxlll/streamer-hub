            ...
            <div className="px-5 py-4 flex items-center gap-4"
              ...
              <div className="text-right flex-shrink-0">
                ...
                <p className="text-xl font-black" style={{ color: "#22c55e" }}>
                  R$ {fmtBRL(item.vencedor.valor ?? 0)}
                </p>
              </div>
            </div>
          )}
            ...
            <div className="space-y-1.5 max-h-72 overflow-y-auto pr-1"
              ...
              {item.jogadores.filter(j => j.valor === null).map(j => (
                <div key={j.id} className="flex items-center gap-3 px-3 py-2 rounded-xl"
                  ...
                  <span className="text-xs font-black w-5 text-center flex-shrink-0" style={{ color: "#374151" }}>—</span>
                  <div className="flex-1 min-w-0">
...
export default function JackpotHistoricoPage() {
    ...
    <div className="page-enter relative min-h-[calc(100vh-4rem)]">
      <div className="relative max-w-3xl mx-auto px-4 sm:px-6 pt-14 pb-24 space-y-5">
        ...
        <div className="flex items-center gap-2 text-xs text-gray-600">
          ...
          <span>/</span>
          <Link href="/arena/jackpot" className="hover:text-gray-400 transition-colors">Jackpot</Link>
          <span>/</span>
        ...
        <div className="flex items-center gap-3">
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-500 mt-1">Todas as batalhas realizadas</p>
          </div>
          <Link href="/arena/jackpot"
            className="px-4 py-2 rounded-xl text-xs font-black text-gray-400 hover:text-white transition-colors"
