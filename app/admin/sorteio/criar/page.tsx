            ...
            <div>
              ...
              {!imagem ? (
                <button type="button" onClick={() => fileRef.current?.click()}
                  ...
                  <span className="text-gray-500 text-left">Clique para enviar uma imagem<br /><span className="text-[11px] text-gray-600">Tamanho ideal: <strong className="text-gray-500">2000 × 400 px</strong> (deitada)</span></span>
                </button>
              ) : (
              ...
              <div className="mt-2 flex items-start gap-2.5 px-3 py-2.5 rounded-xl"
                style={{ background: "rgba(255,186,0,0.06)", border: "1px solid rgba(255,186,0,0.18)" }}>
                <span className="text-base leading-none mt-0.5">📐</span>
                <div className="text-[11px] text-gray-400 leading-relaxed">
                  <p><strong className="text-[#ffba00]">Tamanho ideal: 2000 × 400 px</strong> — imagem deitada (proporção 5:1).</p>
                  <p className="mt-0.5">Deixe o produto bem no <strong className="text-gray-200">centro</strong>. A imagem cobre o card de ponta a ponta, com as laterais escurecidas.</p>
                  <p className="mt-0.5 text-gray-600">Dica: se a sua foto não for desse tamanho, expanda o fundo em um editor (ex: pixelcut.ai) antes de enviar.</p>
                </div>
              </div>
            </div>
